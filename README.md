...
- **Умное определение бэктиков (backtick, сам символ называется Гравис)** - автоматический расчет длины fence для code blocks
...
- [ ] Добавить поддержку ссылок github в качестве пути к проекту
